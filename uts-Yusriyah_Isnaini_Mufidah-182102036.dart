              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: Image(
                      ...
                      fit: BoxFit.cover,
                      image: NetworkImage(
                          'https://media-exp1.licdn.com/dms/image/C5603AQFXWBGI7_EOZA/profile-displayphoto-shrink_200_200/0/1613230377930?e=1619654400&v=beta&t=Ewa_sioBUuBb2VhSpDScjmJlxSdF58D0qC1JfHP5nE8')),
                ),
              ],
            ),
          ],
...
//      BangChan
        CustomListItem(
          ...
          description:
              'Chan bilang dia pindah ke Sydney, Australia ketika dia masih sangat muda. (Tempat kelahirannya masih belum diketahui). Dia memiliki satu adik perempuan, bernama Hannah dan satu adik lelaki, bernama Lucas. Dia bersekolah di Cheongdam High School. (SK-Talk Time 180422). Sebelum meninggalkan Sydney, ia pergi ke Newtown High School of the Performing Arts. Seungmin dan Chan pergi ke sekolah yang sama, dan Chan adalah seniornya. Chan pernah mengambil kelas tari balet dan modern.',
...
//      Lee Know
        CustomListItem(
          ...
          description:
              'Lee Know lahir di Gimpo, Korea Selatan. Dia adalah anak tunggal. Pendidikan: Gimpo Jeil Technical High School (Lulus). Menurut Chan, ayah Minho bekerja di industri mebel. Dia mulai menari sejak masih di sekolah menengah. Dia adalah penari cadangan untuk BTS selama tur Jepang mereka.',
          thumbnail: Image.network(
...
//      Changbin
        CustomListItem(
          ...
          description:
              'Changbin lahir di Yongin, Korea Selatan. Dia memiliki kakak perempuan. Nama panggilannya: Mogi (nyamuk), Jingjingie (cengeng), Teokjaengie (dagu), dan Binnie. Dia lulus dari Bora High School. Dia dilatih selama 2 tahun. Dia berada di grup pre-debut 3RACHA dengan Chan dan Jisung.',
          thumbnail: Image.network(
...
//      Seungmin
        CustomListItem(
          ...
          description:
              'Seungmin lahir di Seoul, Korea Selatan. Seungmin memiliki kakak perempuan. Dia bersekolah di Cheongdam High School. (SK-Talk Time 180422). Nama panggilannya (menurut anggotanya): Siput; nama panggilan yg diberikan oleh penggemar: Sunshine. Dia berbicara bahasa Inggris dengan sangat baik, meskipun dia hanya belajar bahasa Inggris di LA selama 3 bulan ketika dia berada di kelas 4. Seungmin dan Chan pergi ke sekolah yang sama, dan Chan adalah seniornya.',
          thumbnail: Image.network(
